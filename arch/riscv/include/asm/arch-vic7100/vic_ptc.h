#ifndef __VIC_PTC_H__
#define __VIC_PTC_H__
...
#define PTC_BASE_ADDR_SUB(N)    (PWM_BASE_ADDR + ((N>3)?((N-4)*0x10+(1<<15)):(N*0x10))) /// (0xA9040000 + N*0x10)
...
extern void ptc_reset_clock();
extern void ptc_reset();
